...
##_----------------------------------------------------------
                if bottom_point_x - left_point_x == 0 or bottom_point_x - right_point_x == 0:
                    ...
                    tmp_x = int(np.tan(rect[2] / 180 * np.pi) * (-160 + rect[0][1]) + rect[0][0])
                else:
                    tmp_x = int(np.tan((rect[2] - 90) / 180 * np.pi) * (-160 + rect[0][1]) + rect[0][0])
                cv2.circle(img, (tmp_x, 160), 3, (0, 255, 0), 5)
                cv2.line(img, (tmp_x, 160), (320, 160), (0, 0, 255), 5)
                cv2.putText(img, str(tmp_x - 320), (320, 120), font, 1, (0, 0, 255), 2)
##_-----------------------------------------------------------
                cv2.imshow('img', img)
                ...
                if bottom_point_x - left_point_x == 0 or bottom_point_x - right_point_x == 0:
                    return 320 - tmp_x
                    #print("+++++++++++++++++")
                    #return [[tmp_x, 90, int(rect[0][0]), int(rect[0][1]),
                ...
                # 框旋转未达到90度
                    ...
                    return 320 - tmp_x
                    #print("+++++++++++++++++")
                    #return [tmp_x,[-round(rect[2]), int(rect[0][0]), int(rect[0][1]),  # round 返回浮点数四舍五入的值
                ...
                # 框旋转达到超过90度
                    ...
                    #return #[[tmp_x,-round(rect[2]) + 90, int(rect[0][0]), int(rect[0][1]),
                            #(bottom_point_x - left_point_x) * (bottom_point_x - left_point_x) + (
                                        #bottom_point_y - left_point_y) * (bottom_point_y - left_point_y) + (
                                        #bottom_point_x - right_point_x) * (bottom_point_x - right_point_x) + (
                                        #bottom_point_y - right_point_y) * (bottom_point_y - right_point_y)], 
