...
##_-------------
                ...
                ##-----                    
                elif bottom_point_y - top_point_y > 300:
                ...
                if index == 2:
                    return [tmp_x, tmp_angle, int(rect[0][0]) - 320]
                elif index == 1:
                    return [int(rect[0][0]) - 320, (int(rect[0][0]) - 320) / 10, int(rect[0][0])]
...
if cap1.isOpened() and cap2.isOpened():
    while True:
        if  (road_cnt >= 0 and road_cnt <= 10 and del_x < -20):
            a_depth = 45
        elif(road_cnt > 10 and road_cnt <= 20 and del_x < -20):
            a_depth = 45 + 10
        elif(road_cnt > 20 and road_cnt <= 30 and del_x < -20):
            a_depth = 45 + 10
        elif(road_cnt > 30 and road_cnt <= 40 and del_x < -20):
            a_depth = 40
        #a_depth = 30
