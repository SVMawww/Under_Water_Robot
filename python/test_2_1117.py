...
##_-------------
                ...
                ##-----                    
                elif bottom_point_y - top_point_y > 250:
                ...
                cv2.putText(img, str(time_cnt), (640-70, 300), font, 1, (0, 255, 0), 2)
                cv2.putText(img, str(state   ), (640-70, 360), font, 1, (0, 255, 0), 2)
                ...
                if index == 2:
                    ...
                    return [0, (int(rect[0][0]) - 320) / 20, right_point_x - left_point_x]
