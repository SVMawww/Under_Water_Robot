...
##_----------------------------------------------------------
                ...
                tmp_x = -240 + int(np.tan(tmp_angle / 180 * np.pi) * (400 - rect[0][0]) + rect[0][1])
                cv2.circle(img, (400, 240 + tmp_x), 3, (0, 255, 0), 5)
                cv2.line(img, (400, 240 + tmp_x), (400, 240), (0, 0, 255), 5)
                cv2.putText(img, str(tmp_x) + ',' + str(tmp_angle), (430, 240), font, 1, (0, 0, 255), 2)
                
                cv2.line(img, (320-50, 0), (320-50, 480), (0, 255, 0), 5)
                cv2.line(img, (320+50, 0), (320+50, 480), (0, 255, 0), 5)
                if left_point_x > 320+50 or right_point_x < 320-50:
                    if road_cnt % 10 < 5:
                        road_cnt = road_cnt + 1
                else:
                    if road_cnt % 10 >= 5:
                        road_cnt = road_cnt + 1                    
                cv2.putText(img, str(road_cnt), (320-30, 240), font, 1, (0, 255, 0), 2)
##_-----------------------------------------------------------
                cv2.imshow('img', img)
...
##----------------------------------------------------
y_pid = PID(60, -60, 2, 0, 0)
p_pid = PID(30, -30, 1, 0, 0)
z_pid = PID(60, -60, 30, 0, 0)
pitch_pid = PID(40, -40, 20, 0, 0)
