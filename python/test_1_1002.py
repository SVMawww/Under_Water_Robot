...
##_----------------------------------------------------------
                ...
                tmp_x = -240 + int(np.tan(tmp_angle / 180 * np.pi) * (600 - rect[0][0]) + rect[0][1])
                cv2.circle(img, (600, 240 + tmp_x), 3, (0, 255, 0), 5)
                cv2.line(img, (600, 240 + tmp_x), (600, 240), (0, 0, 255), 5)
